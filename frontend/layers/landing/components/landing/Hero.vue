  ...
  <div>
    <div class="relative px-6 lg:px-8">
      ...
      <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
        <svg class="blob-bottom relative left-[calc(50%+3rem)] h-[21.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[42.375rem]" viewBox="0 0 1155 678" xmlns="http://www.w3.org/2000/svg">
...
.blob-bottom {
  animation: blob-float-bottom 8s ease-in-out infinite;
}
</style>
