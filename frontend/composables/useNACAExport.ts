...
export const exportNACALednicer = (
  ...
  // Sort coordinates
  const upperCoords = sortUpperCoordinates(coordinates.upperX, coordinates.upperY)
  const lowerCoords = sortLowerCoordinates(coordinates.lowerX, coordinates.lowerY)
